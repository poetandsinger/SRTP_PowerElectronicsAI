...
The incumbent device for automotive traction. Despite SiC's rise, IGBT still powers most 400V cost-sensitive BEVs and all HEV/PHEVs.
...
The gate driver is the critical interface between the low-voltage control electronics and the high-voltage power switches. It must provide electrical isolation, fast switching, and protection.
...
The interconnection between DC-link capacitor and power module is performance-critical. Stray inductance in the commutation loop (Lσ) sets:
...
← [[circuit-topologies]] | [[control-schemes]] →
