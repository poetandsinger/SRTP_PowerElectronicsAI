...
**Common pattern across all:** AI proposes designs, physics simulation validates, AI learns from the results. None replace simulation — they accelerate the design→simulate→evaluate loop.
