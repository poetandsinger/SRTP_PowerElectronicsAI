...
| Controller | Tesla custom (early TI C2000-class) | [T], [[control-schemes]] §7.1 |
| Inverter cost (2018) | ~**$810** | Munro estimate [94] |

**Why 24 discrete modules, not 3 big ones:** paralleling many small 2-in-1 modules across the phase legs spreads heat and current and let ST use a mature 650 V planar die — a different philosophy from the 3-module CAB450 approach in [[reference-design-wolfspeed-ti-300kw-800v]] [94][92].
...
3. **Control/switching detail is `[T]`** — Tesla does not publish it [[control-schemes]] Red Team.
