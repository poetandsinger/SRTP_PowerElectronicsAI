...
tags: [ai-agents, multi-agent, review, benchmark]
---

## Overview

These agents are **not general-purpose harnesses** — they are purpose-built for specific research tasks. In practice they integrate as **sub-components** within a larger agent framework (Hermes, LangGraph, or CrewAI) rather than serve as the primary harness.
...
These agents should **not** be the primary harness:
