# OpenCode CLI — Architecture Deep Dive

> **Repo:** [github.com/anomalyco/opencode](https://github.com/anomalyco/opencode)  
> **Docs:** [opencode.ai](https://opencode.ai)  
> **License:** MIT  
> **Language:** TypeScript (Effect/Bun, 32+ packages monorepo)  
> **Stars:** 182,896 | **Forks:** 22,658 | **Open Issues:** 4,771  
> **LLM Providers:** 75+ (Anthropic, OpenAI, Google, DeepSeek, Groq, Ollama, OpenRouter, etc.)  
