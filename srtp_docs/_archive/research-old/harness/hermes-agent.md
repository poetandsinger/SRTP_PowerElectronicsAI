...
> **License:** MIT  
> **Language:** Python (54.4 MB) + TypeScript (9.2 MB)  
> **Stars:** 210,142 | **Forks:** 38,464 | **Open Issues:** 26,179  
> **Version:** v0.18.0 | **Commits:** 14,661  
> **Last Updated:** 2026-07-06 (commits within hours)  
> **Status:** ✅ Active — verified 2026-07-06 via GitHub API

## Overview

Hermes Agent is an **open-source, provider-agnostic AI agent framework** by Nous Research. It's designed to be a general-purpose autonomous agent that runs across multiple surfaces (CLI, TUI, desktop GUI, messaging platforms, IDEs) with persistent memory, self-improving skills, and native multi-agent orchestration.

Unlike coding-specific agents (Claude Code, OpenCode, Codex), Hermes is a **general agent harness** — it can do software development, research, system administration, home automation, and anything else that benefits from persistent context and full tool access.
...
**Revolutionary differentiator** — Hermes learns from experience:

- **Self-improving:** When Hermes solves a complex problem or discovers a workflow, it can persist that knowledge as a skill
- **Auto-loading:** Skills matching the current task are injected into the system prompt
- **Curator:** Background process that tracks skill usage, marks idle skills stale, archives them
...
Skills are the mechanism that makes Hermes *better over time* at specific tasks and environments.
