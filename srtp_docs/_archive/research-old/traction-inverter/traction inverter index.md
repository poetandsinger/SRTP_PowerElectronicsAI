# Traction Inverter Industry Research

> **Part of:** [[README]] [[README|SRTP Power Electronics AI]] — Multi-Agent System for Power Electronics  
> **Focus:** Traction inverter fundamentals, topologies, components, control, modeling, and unresolved research questions  
> **Data Source:** OEM teardown reports, IEEE literature, supplier datasheets, Sachs & Neuburger (2025)  
...
| Note | Content |
|------|---------|
| [[research/traction-inverter/what-is-a-traction-inverter]] | First principles: what it does, why it is needed, energy flow, vehicle context |
| [[research/traction-inverter/circuit-topologies]] | Deep dive: 2L-B6, 3L-NPC, 3L-ANPC, 3L-TNPC — circuits, switching states, trade-off matrix |
| [[research/traction-inverter/components]] | Power semiconductors (SiC/IGBT/GaN), gate drivers, DC-link caps, sensors, thermal management |
| [[research/traction-inverter/control-schemes]] | FOC, DTC, MTPA, SVPWM, DPWM, overmodulation, field weakening, ISO 26262 safety |
| [[research/traction-inverter/control-how-to]] | Practical FOC recipe: parameter tuning, MTPA, field weakening, safety limits |
| [[research/traction-inverter/matlab-modeling]] | Simulink/Simscape modeling at 4 fidelity levels, solver config, PLECS integration |
| [[research/traction-inverter/simulation-toolbox]] | Tools, licenses, and hardware needed to run the simulations |
| [[research/traction-inverter/open-problems]] | Active research questions and design tensions |
| [[research/audit-changelog-traction-inverter]] | Source-fidelity audit changelog (what was verified and what was fixed) |

## Reading Order

1. Start with [[research/traction-inverter/what-is-a-traction-inverter]] to understand *why* the inverter exists and what it controls.
2. Read [[research/traction-inverter/circuit-topologies]] to learn the circuit options.
3. Read [[research/traction-inverter/components]] to understand what physical parts make it work.
4. Read [[research/traction-inverter/control-schemes]] for the theory, then [[research/traction-inverter/control-how-to]] for the practical implementation.
5. Read [[research/traction-inverter/matlab-modeling]] and [[research/traction-inverter/simulation-toolbox]] to see how to model and validate it.
6. Finish with [[research/traction-inverter/open-problems]] for the unresolved research questions.
...
← [[research/harness/harness index|Agent Harness Research]] | [[README|SRTP Index]]
