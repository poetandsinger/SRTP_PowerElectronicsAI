# Simulation Toolbox for Traction Inverters
...
- MATLAB is **not installed** on this Windows host. The modeling notes are documented but cannot be executed here.
- A PLECS or PSIM license is **not available**.
...
← [[research/traction-inverter/open-problems]] | [[research/traction-inverter/control-how-to]] →
