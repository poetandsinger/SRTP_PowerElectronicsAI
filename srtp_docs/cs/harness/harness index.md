...
|---------|---------|-------|---------|:---:|:---:|:---:|
| [[cs/harness/hermes-agent]] | **210,142** | 38,464 | MIT | 26,179 | ✅ Native delegation | 🟢 Excellent |
| [[cs/harness/claude-code]] | **136,513** | 21,925 | Proprietary | 9,943 | ✅ @subagents + Teams | 🟡 Moderate |
| [[cs/harness/opencode]] | **182,896** | 22,658 | MIT | 4,771 | ✅ Multi-agent | 🟢 Good |
| [[cs/harness/codex-cli]] | **95,830** | 14,222 | Apache 2.0 | — | ❌ None | 🔴 Poor |
...
| --------------- | --------------------- | ---------- | :-----------------: | :----------: | :----------: | ------------ |
| [[cs/harness/langgraph]]           | **36,626** |         MIT         | ✅ Subgraphs  | 🟢 Excellent | 🟢 Very High |
| [[cs/harness/crewai]]              | **55,014** |         MIT         | ✅ Role-based | 🟢 Excellent | 🟢 High      |
| [[cs/harness/autogen]] | **59,526** |      CC-BY-4.0      | ✅ Group chat |   🟢 Good    | 🟢 High      |
...
- [[cs/harness/langgraph|LangGraph Deep Dive]] — State-machine agent graphs
- [[cs/harness/crewai|CrewAI Deep Dive]] — Role-based multi-agent teams
- [[research-agents|Research-Specific Agents]] — PaperQA2, GPT Researcher, STORM
- [[cs/harness/autogen|AutoGen Deep Dive]] — Microsoft's multi-agent conversations
...
← [[citations|References]] | [[cs/harness/hermes-agent|Next: Hermes Agent]] → | [[README]]
