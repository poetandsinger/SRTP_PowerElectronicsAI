...
tags: [cs, comparison, benchmark, review]
---
...
| Feature | [[cs/harness/hermes-agent]] | [[cs/harness/claude-code]] | [[cs/harness/opencode]] | [[cs/harness/codex-cli]] |
|---------|:---:|:---:|:---:|:---:|
...
| Feature | [[cs/harness/langgraph]] | [[cs/harness/crewai]] | [[cs/harness/autogen]] | LangChain |
|---------|:---:|:---:|:---:|:---:|
...
|---------|-------------------|
| [[cs/harness/hermes-agent]] | Context compression, prompt caching, checkpoint/rollback, multi-profile |
| [[cs/harness/claude-code]] | Context compaction, `/rewind` checkpoints, visual context grid |
| [[cs/harness/opencode]] | Agent mode switching (build ↔ plan), model switching mid-session |
| [[cs/harness/codex-cli]] | Minimal — just prompt, run, exit |

### Tool System

| Harness | Tool Count | Extensibility | Permission Model |
|---------|-----------|---------------|-----------------|
| [[cs/harness/hermes-agent]] | 30+ toolsets | Plugins, MCP, custom Python | Toolset per-platform, approval prompts |
| [[cs/harness/claude-code]] | ~6 + MCP | MCP, hooks, custom commands | allow/ask/deny patterns, hook gates |
| [[cs/harness/opencode]] | Built-in | MCP/ACP | Trust-based |
| [[cs/harness/codex-cli]] | ~4 built-in | None | Sandbox-based (bubblewrap) |

### Memory & Context

| Harness | Cross-Session | Project Context | Self-Improving |
|---------|:---:|:---:|:---:|
| [[cs/harness/hermes-agent]] | ✅ Durable memory store | .hermes.md, AGENTS.md | ✅ Skills accumulate |
| [[cs/harness/claude-code]] | ⚠️ Auto-memory (25KB) | CLAUDE.md hierarchy | ❌ |
| [[cs/harness/opencode]] | ❌ | .opencode/rules/ | ❌ |
| [[cs/harness/codex-cli]] | ❌ | None | ❌ |

### Multi-Agent Support

| Harness | Mechanism | Depth | Concurrent |
|---------|-----------|-------|:---:|
| [[cs/harness/hermes-agent]] | `delegate_task` | Configurable depth | Up to 3 parallel |
| [[cs/harness/claude-code]] | @agent + Agent Teams | Multi-session with P2P | Via tmux worktrees |
| [[cs/harness/opencode]] | Multi-agent | Flat | Built-in |
| [[cs/harness/codex-cli]] | None | — | Manual parallel CLI |

### Scheduling & Automation

| Harness | Cron | Hooks | Webhooks |
|---------|:---:|:---:|:---:|
| [[cs/harness/hermes-agent]] | ✅ Full cron scheduler | ❌ | ✅ Webhook triggers |
| [[cs/harness/claude-code]] | ❌ | ✅ 8 event hooks | ❌ |
| [[cs/harness/opencode]] | ❌ | ❌ | ❌ |
| [[cs/harness/codex-cli]] | ❌ | ❌ | ❌ |
...
| Requirement | [[cs/harness/hermes-agent]] | [[cs/harness/claude-code]] | [[cs/harness/langgraph]] | [[cs/harness/crewai]] |
|-------------|:---:|:---:|:---:|:---:|
...
← [[cs/harness/codex-cli]] | [[architecture-patterns]] → | [[README]]
