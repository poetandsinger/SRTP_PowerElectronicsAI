...
created: 2026-07-10
updated: 2026-07-10
tags: [power-electronics, ai-agents, index, review, synthesis]
---
...
|---------|------|---------|
| §1 Topologies & Semiconductors | [[power-electronics/traction-inverter/topology-landscape-2025-2026]] | 2L/3L/multilevel comparison, SiC vs GaN vs Si IGBT, voltage architecture trends, SiC+GaN coexistence |
| §2 Design Parameters | → Appended to [[power-electronics/traction-inverter/open-problems]] | Critical KPIs, optimization targets, multi-objective trade-offs |
| §3 Simulation Workflows | [[power-electronics/traction-inverter/simulation-workflows-2025-2026]] | 10 tools compared, 10-phase design workflow, pain points |
| §4 Control Strategies | → Appended to [[power-electronics/traction-inverter/control-schemes]] | FOC vs DTC vs MPC head-to-head, AI-enhanced control, sensorless |
| §5 Standards | [[power-electronics/traction-inverter/standards-landscape-2025-2026]] | 11 core standards (IEC, ISO, AEC-Q, AQG 324, CISPR 25), safety goals, emerging WBG standards |
| §6 Market Trends | [[power-electronics/traction-inverter/market-trends-2025-2026]] | $8.75B→$36.8B market, 17.3% CAGR, BYD/Denso/Tesla share, supplier deep dives |

### AI / Design Automation

| Section | Note | Content |
|---------|------|---------|
| §7 AI/ML Applications | [[ai-agents/ai-ml-power-electronics-2025-2026]] | 16 AI application areas with quantitative results, 6 AI paradigms compared |
| §8 Design Automation Gaps | [[ai-agents/design-automation-gaps-2025-2026]] | 10 gaps, 11 AI augmentation opportunities, near-term trajectory |
...
- [[ai-agents/traction-inverter-mas-integration]] — Multi-agent system architecture informed by these findings
- [[ai-agents/implementation-research]] — Technology decisions derived from this research
- [[ai-agents/design-automation-gaps-2025-2026]] — Gaps this project aims to address
