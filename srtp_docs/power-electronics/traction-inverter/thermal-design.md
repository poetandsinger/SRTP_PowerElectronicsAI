...
The thermal chapter: how heat leaves the die, how hot the junction gets, and how that caps continuous torque. Deep-dive behind [[power-electronics/traction-inverter/components]] §6 and [[power-electronics/traction-inverter/design-procedure]] §3. Reference device: Wolfspeed CAB450M12XM3 (1200 V/450 A SiC, Tj,max 175 °C) [92].
...
Production split: **NTC for slow protection/derating; TSEP/model-based for fast condition monitoring** [106]. NTC lag is why the design-procedure derating loop uses a thermal model on top of the NTC ([[power-electronics/traction-inverter/design-procedure]] §6).
...
← [[power-electronics/traction-inverter/components]] | [[power-electronics/traction-inverter/design-procedure]] | [[power-electronics/traction-inverter/packaging-and-layout]] →
