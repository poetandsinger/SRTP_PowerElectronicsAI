...
A **one-stop property reference** for the materials a traction inverter is built from — semiconductor, substrate, die-attach, baseplate, DC-link dielectric, conductor, magnet, insulation. Consolidates constants used across [[power-electronics/traction-inverter/components]], [[power-electronics/traction-inverter/thermal-design]], and [[power-electronics/traction-inverter/packaging-and-layout]]; those chapters give the *why*, this gives the *numbers*.
...
| Max junction (°C) | 150–175 | 175–200 | 150–200 | [[power-electronics/traction-inverter/components]] §1 |

**Read:** SiC's ~10× critical field is the whole ballgame — thinner drift region for the same block voltage → far lower `Rds(on)·area` at 1200 V, and 3× thermal conductivity to remove the loss [22]. GaN's mobility wins at MHz but bulk thermal + 650 V ceiling keep it out of traction [22], [[power-electronics/traction-inverter/components]] §1.3.
...
Si₃N₄ AMB trades some conductivity for the mechanical toughness that survives power cycling — why it dominates automotive modules [T], [[power-electronics/traction-inverter/packaging-and-layout]] §1.
...
|----------|--------------|-----|
| Metallized PP film | self-healing, ESR <1 mΩ, low ESL, Tmax ~105–125 °C | **DC-link cap** — [41], [[power-electronics/traction-inverter/components]] §3 |
...
|----------|----------|------|
| Sintered NdFeB magnet | Br ~1.2–1.4 T; needs Dy/Tb for high-temp coercivity | IPMSM rotor; demag limit [T], [[power-electronics/traction-inverter/machine-and-load]] §6 |
...
Full TIM table in [[power-electronics/traction-inverter/thermal-design]] §5: grease 2.9–7.5, PCM 3–7, graphite 5–15, sintered-Ag 80–280 W/m·K [104].
...
← [[power-electronics/traction-inverter/components]] | [[power-electronics/traction-inverter/thermal-design]] | [[power-electronics/traction-inverter/packaging-and-layout]] →
