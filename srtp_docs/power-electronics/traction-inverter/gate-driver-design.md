...
The gate-driver deep-dive: rails, resistor sizing, protection, isolation, bias, real ICs, worked example. Behind [[power-electronics/traction-inverter/components]] §2 and [[power-electronics/traction-inverter/design-procedure]] §5. Reference device: Wolfspeed CAB450M12XM3 (1200 V/450 A SiC) — all its electrical values below are datasheet-sourced [92].
...
← [[power-electronics/traction-inverter/components]] | [[power-electronics/traction-inverter/schematics]] | [[power-electronics/traction-inverter/protection-and-safety]] →
