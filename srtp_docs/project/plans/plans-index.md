...
| Document | Purpose |
|----------|---------|
| [[project/plans/architecture]] | Why standalone, architecture diagram |
| [[project/plans/tech-stack]] | Complete technology choices |
| [[ai-agents/implementation-research]] | **NEW:** Implementation research: API specifics, code patterns, verified technologies |
| [[ai-agents/traction-inverter-mas-integration]] | Integration architecture: 7-agent design, guardrails, evidence gates |
| [[ai-agents/multi-agent-synthesis]] | Multi-agent patterns from 7 harnesses + 10 papers |
| [[ai-agents/harness/comparative-analysis]] | Feature matrix across all agent harnesses |
| [[power-electronics/problem-statement/problem-statement-index]] | Why this project exists |
| [[citations]] | Master bibliography |
| [[audits/multi-agent-traction-inverter-audit-2026-07-10]] | Latest audit report |

---

← [[README]] | [[project/plans/phase-0-foundation]] →
